      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          ...
          <View style={[styles.contentContainer, { maxWidth: contentMaxWidth }]}>
            <Image
              source={require('../../assets/images/ShareExport.png')}
            ...
            <View style={styles.textContainer}>
              ...
              <Text style={[styles.description, { fontSize: fontSize.desc }]}>
                Export your scanned cards as a CSV file for Outlook and Google Contacts. Share cards digitally with your business connections.
              </Text>
            </View>
